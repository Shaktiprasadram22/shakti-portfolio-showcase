...
const projects = [
  ...
  },
  {
    ...
    description:
      "A productivity application for organizing tasks and managing projects with collaborative features.",
...
const Projects = () => {
  ...
  return (
    <section id="projects" className="section-container bg-white">
      ...
      <UpcomingProjects /> {/* Add the Upcoming Projects section here */}
    </section>
  );
};
