...
const achievements = [
  ...
  },
  {
    ...
    details: "Designed and implemented an intuitive user interface for a web application that received praise from judges for its accessibility, aesthetics, and user-friendly navigation."
  },
  {
    ...
    <section id="achievements" className="section-container bg-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12">
        {achievements.map((achievement, index) => (
          <Card 
            key={index}
            className={`overflow-hidden hover:shadow-lg transition-all duration-300 border-t-4 border-portfolio-teal cursor-pointer ${expandedAchievement === index ? 'ring-2 ring-portfolio-teal' : ''}`}
          ...
          >
            <CardContent className="pt-6 pb-4 px-5">
              <div className="flex flex-col items-center text-center">
                ...
                >
                  <div className="p-4 bg-gray-50 rounded-lg text-sm text-gray-700 border-l-4 border-portfolio-blue">
                    {achievement.details}
                  </div>
                </div>
      ...
      <div className="mt-16 animate-fade-in">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card className="bg-gray-50 border-none hover:shadow-lg transition-all duration-300">
